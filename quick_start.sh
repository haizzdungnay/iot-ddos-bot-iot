...
if [ -f "data/raw/bot_iot.csv" ] || ls data/raw/*.csv 1> /dev/null 2>&1; then
    ...
    echo "=========================================="
    echo ""
    echo "Option 1: IMPACT CyberTrust (Khuyến nghị - Dễ nhất)"
    echo "  Link: https://www.impactcybertrust.org/dataset_view?idDataset=1296"
    echo "  - Miễn phí, dễ download"
    echo "  - CSV format ~16.7GB"
    echo ""
    echo "Option 2: OpenML"
    echo "  Link: https://www.openml.org/d/42072"
    echo "  - Dễ truy cập"
    echo ""
    ...
    echo "  Cài Kaggle CLI: pip install kaggle"
    echo "  Download: kaggle datasets download -d dhoogla/cicbotiot -p data/raw/ --unzip"
    echo ""
